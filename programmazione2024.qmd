...
- **Argomento:** Algebra lineare e analisi delle componenti principali.
  ...
  - A. Regressione bivariata con algebra matriciale.
  - B. Regressione multipla con algebra matriciale.
  - C. Spiegazione geometrica degli autovalori e autovettori.
  - D. Simulazione e applicazione della PCA.
  - E. Analisi PCA per i dati di @greenacre2022principal.
  - F. Discussione dell’articolo di @caron2021variance.
...
- **Introduzione ai modelli SEM**: Presentare i principi e le applicazioni dei modelli di equazioni strutturali (SEM) secondo @kline2023principles.
...
- **Analisi della potenza statistica nei SEM**: Esaminare e applicare i concetti di power analysis nei SEM seguendo il tutorial di @jobst2023tutorial.

- **Esplorazione dell'ESEM**: Presentare i principi e l'applicazione del modello di equazioni strutturali esplorative (ESEM).


## Laboratorio 11 {.unnumbered}

- **Data:** 8 aprile 2025
- **Argomento:** Test di intelligenza, bias nei test, test di personalità.
- **Orario:** 10:30-13:30

  - Presentare e replicare le analisi di @schubert2024don.
