...
odd_even_cor <- 
  2*cor(data$miniq_even, data$miniq_odd)/(1+cor(data$miniq_even, data$miniq_odd))
...
summary(fit_cor, fit.measures=TRUE,standardized = TRUE, rsquare=TRUE)
...
standardizedSolution(fit_mreg_mod1)
